...
Route::group(['prefix' => 'painel'], function () {
    ...
    Route::group(['middleware' => 'auth'], function()
    {
      ...
      Route::get('/meusEventos/Rdf/{eventoId}', 'BackendController@rdfEvento');
      Route::get('/meusEventos/RdfDown/{eventoId}', 'BackendController@rdfEventodown');
      ...
      Route::get('/perfilRdf/{idUsuario}', 'Backend\UserController@RDF');
